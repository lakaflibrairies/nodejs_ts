...
import {
  LakafControllerAction,
  LakafMiddlewareAction,
  LakafMiddlewareRouting,
  LakafResourceControllerInterface,
  LakafRouterGroupCallback,
  LakafRouterGroupELement,
  LakafRouterMiddlewareCallback,
  LakafResourceArray,
} from "../types/index";
...
export default class LakafRouting extends LakafAbstract {
  ...
  _get(
    brick: string,
    middlewares: Array<LakafMiddlewareAction>,
  ...
  _group(
    brick: string,
    routerGroup: LakafRouterGroupELement[] | LakafRouterGroupCallback
  ): LakafRouting {
    if (typeof routerGroup === "function") {
      let routerChild: LakafRouting = new LakafRouting();
      ...
      console.error(
        "Bad router group. A router group must be a function or an array of RouterGroupObject."
      );
  ...
  _middleware(
    things: LakafMiddlewareAction[],
    middlewareRouting: LakafRouterMiddlewareCallback
  ): LakafRouting {
    let routerMiddleware: LakafMiddlewareRouting = {
      _get: (
        brick: string,
        middlewares: Array<LakafMiddlewareAction>,
        controller: LakafControllerAction
  ...
  _module(brick: string, routingModule: LakafRouting): LakafRouting {
